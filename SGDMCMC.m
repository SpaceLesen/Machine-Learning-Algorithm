...
subplot(3,2,1)
plot(meas, 'linewidth',1); title('Original Data');%area
ax = gca; ax.FontSize = 12; ax.FontWeight='bold'; grid on;
subplot(3,2,2)
plot(Syn, 'linewidth',1); title('Synthetic Data');%area
ax = gca; ax.FontSize = 12; ax.FontWeight='bold'; grid on;
subplot(3,2,3)
gscatter(f1,f2,Target,'rbg','.',20); title('Original');%rkg
ax = gca; ax.FontSize = 12; ax.FontWeight='bold'; grid on;
subplot(3,2,4)
gscatter(ff1,ff2,Lbl,'rbg','.',20); title('Synthetic');%rkg
ax = gca; ax.FontSize = 12; ax.FontWeight='bold'; grid on;
subplot(3,2,[5 6])
